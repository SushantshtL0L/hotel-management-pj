...
class Customerwin:
  def __init__(self,root):
    ...
    #________________________variBale________________________

    self.var_ref=StringVar()
    x=random.randint(1000,9990)
    self.var_ref.set(str(x))

    self.var_cutomer_name=StringVar()
    ...
    label_title=Label(self.root,text="ENTER  CUSTOMER  DETAILS",font=("times new roman",40,"bold"),bg="black",fg="gold",bd=1,relief=RIDGE)
    ...
    entry1=ttk.Entry(labelframeleft,width=22,textvariable=self.var_cutomer_name,font=('times new roman',15,"bold"))
    ...
    entry2=ttk.Entry(labelframeleft,width=22,textvariable=self.var_Email,font=('times new roman',15,"bold"))
    ...
    entry3=ttk.Entry(labelframeleft,width=22,textvariable=self.var_Phone_number,font=('times new roman',15,"bold"))
    ...
    combo_gender=ttk.Combobox(labelframeleft,textvariable=self.var_Gender,font=("arial",15,"bold"),width=18,state="readonly")
    ...
    entry4=ttk.Entry(labelframeleft,textvariable=self.var_Address,width=22,font=('times new roman',15,"bold"))
    ...
    entry5=ttk.Entry(labelframeleft,textvariable=self.var_Nationality,width=22,font=('times new roman',15,"bold"))
    ...
    combo_ID=ttk.Combobox(labelframeleft,textvariable=self.var_Id_proof,font=("arial",15,"bold"),width=18,state="readonly")
    ...
    entry6=ttk.Entry(labelframeleft,textvariable=self.var_Id_number,width=22,font=('times new roman',15,"bold"))
    entry6.grid(row=150,column=1)


    #____________________________BUTTONS___________________________________________
