...
con = mysql.connector.connect(host="localhost", user="root", password="Suvam@123", database="hotel")
cursor = con.cursor()
def delete_record():
...
def store_data():
    ...
    sql = "INSERT INTO customer (customer_contact, check_in_date, check_out_date, room_type, days) VALUES (%s, %s, %s, %s, %s)"
    val = (customer_contact, check_in_date, check_out_date, room_type, days)
...
img5 = Image.open("C:\\Users\\dell\\Pictures\\Camera Roll\\WIN_20220516_16_54_03_Pro.jpg")
...
label_title = Label(root, text="ROOM  BOOKING", font=("times new roman", 40, "bold"), bg="white", fg="blue", bd=3, relief=RIDGE)
...
query = "SELECT customer_contact, check_in_date, check_out_date, room_type, days FROM customer"
